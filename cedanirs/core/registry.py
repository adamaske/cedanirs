...
Adding a new connectivity method to cedanirs is deliberately a two-line affair:
subclass :class:`~cedanirs.estimators.base.ConnectivityEstimator` and decorate
it with :func:`register_estimator`. From that point the method is reachable by
name through :func:`cedanirs.connectivity`, appears in
