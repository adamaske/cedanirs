...
All return a :class:`~cedanirs.stats._results.GroupStatResult` (or
:class:`~cedanirs.stats._results.NBSResult`) which carries effect sizes, CIs,
corrected q-values, and a ``.to_matrix()`` bridge into the rest of cedanirs.
"""
