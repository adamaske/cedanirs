...
lazily inside methods so that ``import nirconn`` stays cheap and side-effect
free.
"""
...
class ConnectivityMatrix:
    ...
    kind:
        :class:`~nirconn.core.types.ConnectivityKind`.
    directed:
    ...
    def plot(self, **kwargs) -> "Axes":
        """Render the matrix as a heatmap (see :func:`nirconn.viz.plot_matrix`)."""
...
class ConnectivityResult:
    ...
    def report(self, **kwargs) -> str:
        """A formatted, human-readable text report (see :mod:`nirconn.report`)."""
