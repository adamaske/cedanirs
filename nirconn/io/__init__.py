...
:class:`~nirconn.core.timeseries.NirsTimeSeries` for connectivity analysis.
...
``h5py`` is an optional dependency (``pip install 'nirconn[io]'``); it is
imported lazily so importing nirconn never requires it.
"""
